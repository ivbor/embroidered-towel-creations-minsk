      ...
      <section className="py-16 bg-stone-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {/* Mock Instagram posts - replace with real Instagram embed */}
            <div className="aspect-square bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-full h-full bg-gradient-to-br from-amber-100 to-amber-200 flex items-center justify-center">
                <div className="text-center p-4">
                  <Palette className="h-8 w-8 text-amber-600 mx-auto mb-2" />
                  <p className="text-sm font-medium text-amber-700">Корпоративная вышивка</p>
                </div>
              </div>
            </div>
            ...
            <div className="aspect-square bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-full h-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center">
                <div className="text-center p-4">
                  ...
                  <p className="text-sm font-medium text-blue-700">Подарочные наборы</p>
                </div>
              </div>
            </div>
            ...
            <div className="aspect-square bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-full h-full bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center">
                <div className="text-center p-4">
                  ...
                  <p className="text-sm font-medium text-green-700">Качественная вышивка</p>
                </div>
              </div>
            </div>
            ...
            <div className="aspect-square bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-full h-full bg-gradient-to-br from-purple-100 to-purple-200 flex items-center justify-center">
                <div className="text-center p-4">
                  ...
                  <p className="text-sm font-medium text-purple-700">Упаковка премиум</p>
                </div>
              </div>
            </div>
            ...
            <div className="aspect-square bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-full h-full bg-gradient-to-br from-rose-100 to-rose-200 flex items-center justify-center">
                <div className="text-center p-4">
                  ...
                  <p className="text-sm font-medium text-rose-700">Свадебные полотенца</p>
                </div>
              </div>
            </div>
            ...
            <div className="aspect-square bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-full h-full bg-gradient-to-br from-teal-100 to-teal-200 flex items-center justify-center">
                <div className="text-center p-4">
                  ...
                  <p className="text-sm font-medium text-teal-700">Индивидуальный дизайн</p>
                </div>
              </div>
            </div>
            ...
            <div className="aspect-square bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-full h-full bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center">
                <div className="text-center p-4">
                  ...
                  <p className="text-sm font-medium text-orange-700">Быстрое изготовление</p>
                </div>
              </div>
            </div>
            ...
            <div className="aspect-square bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-full h-full bg-gradient-to-br from-indigo-100 to-indigo-200 flex items-center justify-center">
                <div className="text-center p-4">
                  ...
                  <p className="text-sm font-medium text-indigo-700">Доставка по СНГ</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600 text-sm mb-4">
              Для отображения актуальных фото с Instagram можно встроить официальный виджет
            </p>
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <p className="text-sm text-gray-500 mb-4">
                Здесь можно разместить официальный Instagram-виджет для отображения реальных постов с аккаунта @rusan.by
              </p>
              <Button 
                variant="outline" 
                size="sm"
