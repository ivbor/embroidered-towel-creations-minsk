          ...
          <div className="md:hidden h-[20vh] max-h-40 flex flex-col justify-center">
            ...
            <div className="flex justify-center items-center space-x-6 mb-4">
              <Button 
                ...
                onClick={handleTelegramClick}
              >
                <svg width="48px" height="48px" viewBox="0 0 9.6 9.6" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Button 
                ...
                onClick={handleInstagramClick}
              >
                <svg width="48px" height="48px" viewBox="0 0 14.4 14.4" fill="none" xmlns="http://www.w3.org/2000/svg">
