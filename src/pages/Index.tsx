      ...
      <section className="py-16 bg-stone-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-gradient-to-br from-pink-200 to-purple-200 rounded-lg p-6 h-48 flex items-center justify-center">
              <p className="text-gray-700 text-center">Instagram галерея работ</p>
            </div>
            <div className="bg-gradient-to-br from-blue-200 to-cyan-200 rounded-lg p-6 h-48 flex items-center justify-center">
              <p className="text-gray-700 text-center">Примеры вышивки</p>
            </div>
            <div className="bg-gradient-to-br from-yellow-200 to-orange-200 rounded-lg p-6 h-48 flex items-center justify-center">
              <p className="text-gray-700 text-center">Готовые полотенца</p>
            </div>
            <div className="bg-gradient-to-br from-green-200 to-emerald-200 rounded-lg p-6 h-48 flex items-center justify-center">
              <p className="text-gray-700 text-center">Корпоративные заказы</p>
            </div>
          </div>
        </div>
